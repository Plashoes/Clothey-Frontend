...
function Testimonials() {
  return (
    <div className="container mx-auto px-6 py-12 flex flex-col xl:flex-row xl:space-x-12 items-center border-b-2 border-[#e6e6e6]">
      <div>
        <p className="text-center">AS SEEN IN:</p>
      </div>
